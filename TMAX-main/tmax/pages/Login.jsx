    ...
    Seu Perfil
      ...
      <div className="flex flex-col items-center justify-center mt-20">
        <div className="bg-black text-white p-10 rounded-3xl w-96 text-center">
          ...
          {/* Campos */}
          <input type="text" placeholder="Seu nome completo" className="w-full mb-4 px-4 py-3 rounded-full bg-white text-gray-800 placeholder-gray-500 focus:outline-none" />
          <input type="text" placeholder="CPF" className="w-full mb-4 px-4 py-3 rounded-full bg-white text-gray-800 placeholder-gray-500 focus:outline-none" />
          <input type="text" placeholder="(11) 99999-9999" className="w-full mb-6 px-4 py-3 rounded-full bg-white text-gray-800 placeholder-gray-500 focus:outline-none" />

          {/* Botão */}
          <button
            className="w-full bg-white text-black font-semibold py-3 rounded-full hover:bg-gray-200 transition"
            onClick={() => navigate("/driver-registration")} // <-- navegação
          >
            Continuar
          </button>
          ...
          <div className="flex items-start text-xs text-left mt-4">
            ...
            />
            <p>
              Concordo em fornecer meus dados para receber conteúdos e ofertas por <span className="font-bold underline">e-mail</span>.
            </p>
          </div>
        </div>
      </div>
