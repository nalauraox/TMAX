      ...
      <main className="flex justify-center py-10 px-6 flex-1 w-full">
        ...
        <div className="w-[400px] flex flex-col items-center">
          ...
          <div className="w-full bg-gray-100 p-4 rounded-lg mb-6">
            ...
            <p><strong>Moto:</strong> Honda CG 160, Placa ABC-1234</p>
            <p><strong>Cor:</strong> Vermelha</p>
          </div>
          ...
          <p className="text-xs text-center">
            Ao finalizar, você confirma que todas as informações estão corretas e concorda com a <span className="text-red-600 underline">Política de Serviço</span> e <span className="text-red-600 underline">termos de uso</span>.
          </p>
        </div>
      </main>
