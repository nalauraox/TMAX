...
const handleSubmit = async () => {
  ...
  const [rgFiles, setRgFiles] = useState([]);       // Files reais
  const [rgPreviews, setRgPreviews] = useState([]); // URLs para exibição

  // ===== DADOS SALVOS =====
  const [savedDriver, setSavedDriver] = useState(null);

  // Conversor File -> Base64 para salvar no localStorage
